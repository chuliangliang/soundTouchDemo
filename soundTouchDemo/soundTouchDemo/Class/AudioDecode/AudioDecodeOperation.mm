    ...
    try {
        ...
        if (noErr == error) {
            ...
            if (kAudioConverterErr_PropertyNotSupported == error) {
                ...
                CNLog(@"AudioDecode-Debug: AudioConverterGetProperty kAudioConverterPropertyCanResumeFromInterruption result %d\n", (int)error);
            }
        ...
        while (1) {
            ...
            if (error) {
                ...
                if (kExtAudioFileError_CodecUnavailableInputConsumed == error) {
                    ...
                    CNLog(@"AudioDecode-Debug: ExtAudioFileWrite kExtAudioFileError_CodecUnavailableInputConsumed error %d\n", (int)error);
                    ...
                    CNLog(@"AudioDecode-Debug: ExtAudioFileWrite kExtAudioFileError_CodecUnavailableInputNotConsumed error %d\n", (int)error);
