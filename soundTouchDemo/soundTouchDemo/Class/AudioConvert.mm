...
@property (weak, nonatomic) id<AudioConvertDelegate>delegate;
...
- (void)audioConvertBegin:(AudioConvertConfig )config withCallBackDelegate:(id<AudioConvertDelegate>)aDelegate
{
    myConfig = config;
...
//TODO: 音频解码入口
//==============================================================================
- (void)audioConvertBeginDecode:(NSString *)sourceAudioPath withCallBackDelegate:(id<AudioConvertDelegate>)aDelegate
{
...
//==============================================================================
- (void)audioConvertBeginSoundTouch:(NSString *)sourceAudioPath withCallBackDelegate:(id<AudioConvertDelegate>)aDelegate
